...
!(function (e) {
        ...
        for (var r = n.firstChild; r; r = r.nextSibling)
          3 === r.nodeType
            ...
            : 1 === r.nodeType &&
              ...
              (t = e(r, t)),
              E(r).match(/br|hr|img|input/) || a.push({ event: 'stop', offset: t, node: r }));
        return t;
      })(e, 0),
      a
    );
  ...
  function d(e, n, t) {
    ...
    for (; e.length || n.length; ) {
      ...
      if (((a += C(t.substring(r, s[0].offset))), (r = s[0].offset), s === e)) {
        for (i.reverse().forEach(l); o(s.splice(0, 1)[0]), (s = c()) === e && s.length && s[0].offset === r; );
        i.reverse().forEach(u);
      } else 'start' === s[0].event ? i.push(s[0].node) : i.pop(), o(s.splice(0, 1)[0]);
    }
            ...
            for (var t = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, r = 0, a = '', i = 0; i < e.length; i++) {
              ...
              for (0 < i && (a += n), a += '('; 0 < u.length; ) {
                ...
                (a += u.substring(0, l.index)),
                  ...
                  '\\' == l[0][0] && l[1] ? (a += '\\' + String(Number(l[1]) + c)) : ((a += l[0]), '(' == l[0] && r++);
              }
              a += ')';
            }
            return a;
  ...
  function x(e, a, i, n) {
      ...
      (R +=
        null != g.sL
          ? (function () {
              ...
              var n = e ? x(g.sL, v, !0, d[g.sL]) : B(v, g.sL.length ? g.sL : void 0);
              return 0 < g.relevance && (p += n.relevance), e && (d[g.sL] = n.top), u(n.language, n.value, !1, !0);
            })()
          : (function () {
              var e, n, t, r, a, i, c;
              if (!g.k) return C(v);
              for (r = '', n = 0, g.lR.lastIndex = 0, t = g.lR.exec(v); t; )
                (r += C(v.substring(n, t.index))),
                  ...
                  (e = a.k.hasOwnProperty(c) && a.k[c]) ? ((p += e[1]), (r += u(e[0], C(t[0])))) : (r += C(t[0])),
                  (n = g.lR.lastIndex),
                  (t = g.lR.exec(v));
    ...
    function o(e) {
      (R += e.cN ? u(e.cN, '', !0) : ''), (g = Object.create(e, { parent: { value: g } }));
    }
    function s(e) {
      var n = e[0],
        t = e.rule;
    ...
    function t(e, n) {
      ...
      if ('begin' == f.type && 'end' == n.type && f.index == n.index && '' === t)
        return (v += a.slice(n.index, n.index + 1)), 1;
      if ('begin' === (f = n).type) return s(n);
      if ('illegal' === n.type && !i)
        throw new Error('Illegal lexeme "' + t + '" for mode "' + (g.cN || '<unnamed>') + '"');
      if ('end' === n.type) {
        var r = (function (e) {
          var n = e[0],
            t = c(g, n);
          if (t) {
            var r = g;
            for (
              r.skip ? (v += n) : (r.rE || r.eE || (v += n), l(), r.eE && (v = n));
              g.cN && (R += _), g.skip || g.sL || (p += g.relevance), (g = g.parent) !== t.parent;

            );
            return t.starts && (t.endSameAsBegin && (t.starts.eR = t.eR), o(t.starts)), r.rE ? 0 : n.length;
          }
        })(n);
        if (null != r) return r;
      }
    ...
    try {
      ...
      if (e.message && -1 !== e.message.indexOf('Illegal')) return { i: !0, relevance: 0, value: C(a) };
      throw e;
    }
  }
  function B(t, e) {
  ...
  function M(e) {
    return m.tabReplace || m.useBR
      ? e.replace(t, function (e, n) {
          return m.useBR && '\n' === e ? '<br>' : m.tabReplace ? n.replace(/\t/g, m.tabReplace) : '';
        })
      : e;
  }
  function N(e) {
    var n,
      ...
      c = (function (e) {
        ...
        for (n = 0, r = (i = i.split(/\s+/)).length; n < r; n++) if (o((a = i[n])) || S(a)) return a;
      })(e);
    o(c) ||
      (m.useBR
...
hljs.registerLanguage('perl', function (e) {
  var t =
    ...
    s = { b: '->{', e: '}' },
    n = {
      v: [{ b: /\$\d/ }, { b: /[\$%@](\^\w\b|#\w+(::\w+)*|{\w+}|\w+(::\w*)*)/ }, { b: /[\$%@][^\s\w{]/, relevance: 0 }],
    },
    c = [e.BE, r, n],
    a = [
      n,
  ...
  return {
    ...
    c: [
      ...
      },
      {
        ...
        c: [t, e.QSM, e.ASM, i, e.CSSNM, { b: '\\s[A-Za-z0-9_.-]+', relevance: 0 }],
      },
    ],
  };
});
...
hljs.registerLanguage('typescript', function (e) {
  var r = '[A-Za-z$_][0-9A-Za-z$_]*',
    ...
    s = {
      cN: 'number',
      v: [{ b: '\\b(0[bB][01]+)n?' }, { b: '\\b(0[oO][0-7]+)n?' }, { b: e.CNR + 'n?' }],
      relevance: 0,
    },
        ...
        c: [
          ...
          e.RM,
          {
            ...
            c: [
              {
                cN: 'params',
                v: [{ b: r }, { b: /\(\s*\)/ }, { b: /\(/, e: /\)/, eB: !0, eE: !0, k: a, c: i }],
              },
            ],
          },
          { cN: '', b: /\s/, e: /\s*/, skip: !0 },
  ...
  return {
    ...
    c: n.concat([
      ...
      { b: e.IR + '::', k: a },
      {
        ...
        k: a,
        c: n.concat([{ b: /\(/, e: /\)/, k: a, c: n.concat(['self']), relevance: 0 }]),
        relevance: 0,
      },
      {
        cN: 'function',
