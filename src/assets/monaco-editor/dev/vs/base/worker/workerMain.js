...
(function () {
      ...
      Utilities.getHighPerformanceTimestamp = function () {
        if (!this.PERFORMANCE_NOW_PROBED) {
          ...
          this.HAS_PERFORMANCE_NOW =
            AMDLoader.global.performance && typeof AMDLoader.global.performance.now === 'function';
        }
      ...
      NodeScriptLoader.prototype.load = function (moduleManager, scriptSrc, callback, errorback) {
        ...
        if (/^node\|/.test(scriptSrc)) {
          ...
          var cachedDataPath_1 = wantsCachedData_1
            ...
            : undefined;
          this._readSourceAndCachedData(normalizedScriptSrc_1, cachedDataPath_1, recorder, function (
            err,
            data,
            cachedData,
            hashData
      ...
      ModuleManager.prototype.getBuildInfo = function () {
        ...
        for (var i = 0, len = this._modules2.length; i < len; i++) {
          ...
          result[resultLen++] = {
            ...
            path: location_1,
            defineLocation:
              location_1 && defineStack ? ModuleManager._findRelevantLocationInStack(location_1, defineStack) : null,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[16 /*vs/base/common/keyCodes*/], __M([
    0 /*require*/,
    1 /*exports*/,
    4 /*vs/base/common/errors*/,
  ]), function (require, exports, errors_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
  ...
  define(__m[6 /*vs/base/common/lifecycle*/], __M([
    0 /*require*/,
    1 /*exports*/,
    15 /*vs/base/common/iterator*/,
  ]), function (require, exports, iterator_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[7 /*vs/base/common/event*/], __M([
    0 /*require*/,
    1 /*exports*/,
    4 /*vs/base/common/errors*/,
    6 /*vs/base/common/lifecycle*/,
    17 /*vs/base/common/linkedList*/,
  ]), function (require, exports, errors_1, lifecycle_1, linkedList_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[18 /*vs/base/common/cancellation*/], __M([
    0 /*require*/,
    1 /*exports*/,
    7 /*vs/base/common/event*/,
    ...
    (function (CancellationToken) {
      function isCancellationToken(thing) {
        ...
        return (
          typeof thing.isCancellationRequested === 'boolean' && typeof thing.onCancellationRequested === 'function'
        );
      }
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[19 /*vs/base/common/process*/], __M([
    0 /*require*/,
    1 /*exports*/,
    3 /*vs/base/common/platform*/,
  ]), function (require, exports, platform_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[20 /*vs/base/common/path*/], __M([0 /*require*/, 1 /*exports*/, 19 /*vs/base/common/process*/]), function (
    require,
    exports,
    process
  ) {
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[21 /*vs/base/common/hash*/], __M([0 /*require*/, 1 /*exports*/, 8 /*vs/base/common/strings*/]), function (
    require,
    exports,
    strings
  ) {
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[9 /*vs/base/common/diff/diff*/], __M([
    0 /*require*/,
    1 /*exports*/,
    14 /*vs/base/common/diff/diffChange*/,
    21 /*vs/base/common/hash*/,
  ]), function (require, exports, diffChange_1, hash_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    class LcsDiff {
      ...
      constructor(originalSequence, modifiedSequence, continueProcessingPredicate = null) {
        ...
        const [originalStringElements, originalElementsOrHash, originalHasStrings] = LcsDiff._getElements(
          originalSequence
        );
        const [modifiedStringElements, modifiedElementsOrHash, modifiedHasStrings] = LcsDiff._getElements(
          modifiedSequence
        );
      ...
      ChangesOverlap(left, right, mergedChangeArr) {
        ...
        if (
          ...
          mergedChangeArr[0] = new diffChange_1.DiffChange(
            originalStart,
            originalLength,
            modifiedStart,
            modifiedLength
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[12 /*vs/base/common/uri*/], __M([
    0 /*require*/,
    1 /*exports*/,
    3 /*vs/base/common/platform*/,
    20 /*vs/base/common/path*/,
  ]), function (require, exports, platform_1, paths) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[33 /*vs/base/common/worker/simpleWorker*/], __M([
    0 /*require*/,
    1 /*exports*/,
    4 /*vs/base/common/errors*/,
    6 /*vs/base/common/lifecycle*/,
    3 /*vs/base/common/platform*/,
    10 /*vs/base/common/types*/,
  ]), function (require, exports, errors_1, lifecycle_1, platform_1, types) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[22 /*vs/editor/common/core/characterClassifier*/], __M([
    0 /*require*/,
    1 /*exports*/,
    11 /*vs/base/common/uint*/,
  ]), function (require, exports, uint_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[5 /*vs/editor/common/core/range*/], __M([
    0 /*require*/,
    1 /*exports*/,
    2 /*vs/editor/common/core/position*/,
  ]), function (require, exports, position_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[23 /*vs/editor/common/core/selection*/], __M([
    0 /*require*/,
    1 /*exports*/,
    2 /*vs/editor/common/core/position*/,
    5 /*vs/editor/common/core/range*/,
  ]), function (require, exports, position_1, range_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[25 /*vs/editor/common/diff/diffComputer*/], __M([
    0 /*require*/,
    1 /*exports*/,
    9 /*vs/base/common/diff/diff*/,
    8 /*vs/base/common/strings*/,
  ]), function (require, exports, diff_1, strings) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[26 /*vs/editor/common/model/wordHelper*/], __M([0 /*require*/, 1 /*exports*/]), function (
    require,
    exports
  ) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[27 /*vs/editor/common/modes/linkComputer*/], __M([
    0 /*require*/,
    1 /*exports*/,
    22 /*vs/editor/common/core/characterClassifier*/,
  ]), function (require, exports, characterClassifier_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    class LinkComputer {
      static _createLink(classifier, line, lineNumber, linkBeginIndex, linkEndIndex) {
        ...
        if (linkBeginIndex > 0) {
          ...
          if (
            (charCodeBeforeLink === 40 /* OpenParen */ && lastCharCodeInLink === 41) /* CloseParen */ ||
          ...
          while (j < len) {
            ...
            if (state === 13 /* Accept */) {
              ...
              switch (chCode) {
                ...
                case 96 /* BackTick */:
                  chClass =
                    linkBeginChCode === 39 /* SingleQuote */ || linkBeginChCode === 34 /* DoubleQuote */
                      ? 0 /* None */
                      : 1 /* ForceTermination */;
                  break;
                case 42 /* Asterisk */:
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[28 /*vs/editor/common/modes/supports/inplaceReplaceSupport*/], __M([
    0 /*require*/,
    1 /*exports*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[29 /*vs/editor/common/standalone/standaloneEnums*/], __M([0 /*require*/, 1 /*exports*/]), function (
    require,
    exports
  ) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[30 /*vs/editor/common/standalone/standaloneBase*/], __M([
    0 /*require*/,
    1 /*exports*/,
    18 /*vs/base/common/cancellation*/,
    7 /*vs/base/common/event*/,
    16 /*vs/base/common/keyCodes*/,
    12 /*vs/base/common/uri*/,
    2 /*vs/editor/common/core/position*/,
    5 /*vs/editor/common/core/range*/,
    23 /*vs/editor/common/core/selection*/,
    24 /*vs/editor/common/core/token*/,
    29 /*vs/editor/common/standalone/standaloneEnums*/,
  ]), function (
    require,
    exports,
    cancellation_1,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[31 /*vs/editor/common/viewModel/prefixSumComputer*/], __M([
    0 /*require*/,
    1 /*exports*/,
    11 /*vs/base/common/uint*/,
  ]), function (require, exports, uint_1) {
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[32 /*vs/editor/common/model/mirrorTextModel*/], __M([
    0 /*require*/,
    1 /*exports*/,
    2 /*vs/editor/common/core/position*/,
    31 /*vs/editor/common/viewModel/prefixSumComputer*/,
  ]), function (require, exports, position_1, prefixSumComputer_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
      ...
      onEvents(e) {
        ...
        for (const change of changes) {
          ...
          this._acceptInsertText(
            new position_1.Position(change.range.startLineNumber, change.range.startColumn),
            change.text
          );
        }
  ...
  define(__m[34 /*vs/editor/common/services/editorSimpleWorker*/], __M([
    0 /*require*/,
    1 /*exports*/,
    13 /*vs/base/common/arrays*/,
    9 /*vs/base/common/diff/diff*/,
    3 /*vs/base/common/platform*/,
    12 /*vs/base/common/uri*/,
    2 /*vs/editor/common/core/position*/,
    5 /*vs/editor/common/core/range*/,
    25 /*vs/editor/common/diff/diffComputer*/,
    32 /*vs/editor/common/model/mirrorTextModel*/,
    26 /*vs/editor/common/model/wordHelper*/,
    27 /*vs/editor/common/modes/linkComputer*/,
    28 /*vs/editor/common/modes/supports/inplaceReplaceSupport*/,
    30 /*vs/editor/common/standalone/standaloneBase*/,
    10 /*vs/base/common/types*/,
  ]), function (
    require,
    exports,
    ...
    class MirrorModel extends mirrorTextModel_1.MirrorTextModel {
      ...
      getWordAtPosition(position, wordDefinition) {
        let wordAtText = wordHelper_1.getWordAtText(
          position.column,
          wordHelper_1.ensureValidWordDefinition(wordDefinition),
    ...
    class EditorSimpleWorker {
      ...
      navigateValueSet(modelUrl, range, up, wordDef, wordDefFlags) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          let result = inplaceReplaceSupport_1.BasicInplaceReplace.INSTANCE.navigateValueSet(
            range,
            selectionText,
            wordRange,
            word,
