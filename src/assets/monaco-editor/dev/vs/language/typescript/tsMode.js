...
define('vs/language/typescript/workerManager', ['require', 'exports', './fillers/monaco-editor-core'], function (
  require,
  exports,
      ...
      if (!this._client) {
        ...
        if (this._defaults.getEagerModelSync()) {
          p = p.then(function (worker) {
            if (_this._worker) {
              return _this._worker.withSyncedResources(
                monaco_editor_core_1.editor
                  .getModels()
...
], function (require, exports, lib_index_1, monaco_editor_core_1) {
  /*---------------------------------------------------------------------------------------------
   *  Copyright (c) Microsoft Corporation. All rights reserved.
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              promises = [];
              (_a = this._defaults.getDiagnosticsOptions()),
                (noSyntaxValidation = _a.noSyntaxValidation),
                (noSemanticValidation = _a.noSemanticValidation),
                (noSuggestionDiagnostics = _a.noSuggestionDiagnostics);
              ...
              relatedUris = diagnostics
                ...
                .map(function (relatedInformation) {
                  return relatedInformation.file
                    ? monaco_editor_core_1.Uri.parse(relatedInformation.file.fileName)
                    : null;
                });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              wordRange = new monaco_editor_core_1.Range(
                position.lineNumber,
            ...
            case 2:
              ...
              return [
                ...
                this._libFiles.fetchLibFilesIfNecessary(
                  entries.map(function (entry) {
                    return monaco_editor_core_1.Uri.parse(entry.fileName);
                  })
                ),
              ];
            case 3:
            ...
            case 2:
              ...
              actions = codeFixes
                .filter(function (fix) {
                  ...
                  return (
                    fix.changes.filter(function (change) {
...
define('vs/language/typescript/tsMode', [
  ...
  function setupMode(defaults, modeId) {
    ...
    monaco_editor_core_1.languages.registerSignatureHelpProvider(
      modeId,
    ...
    monaco_editor_core_1.languages.registerDefinitionProvider(
      modeId,
      new languageFeatures.DefinitionAdapter(libFiles, worker)
    );
    monaco_editor_core_1.languages.registerReferenceProvider(
      modeId,
    ...
    monaco_editor_core_1.languages.registerOnTypeFormattingEditProvider(
      modeId,
