...
define('vs/editor/editor.main.nls.es', {
  ...
  'vs/editor/contrib/codelens/codelensController': ['Mostrar comandos de lente de código para la línea actual'],
  ...
  'vs/editor/contrib/cursorUndo/cursorUndo': ['Cursor Deshacer', 'Cursor Rehacer'],
  ...
  'vs/editor/contrib/format/formatActions': ['Dar formato al documento', 'Dar formato a la selección'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['Haga clic para mostrar {0} definiciones.'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['Cargando...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} referencias', '{0} referencia', 'Referencias'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['Símbolo {0} de {1}, {2} para el siguiente', 'Símbolo {0} de {1}'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['Desarrollador: forzar nueva aplicación de token'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['comandos globales', 'comandos del editor', '{0}, {1}'],
