...
define('vs/editor/editor.main.nls', {
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['The number of cursors has been limited to {0}.'],
  ...
  'vs/editor/contrib/caretOperations/caretOperations': ['Move Selected Text Left', 'Move Selected Text Right'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['Show CodeLens Commands For Current Line'],
  ...
  'vs/editor/contrib/fontZoom/fontZoom': ['Editor Font Zoom In', 'Editor Font Zoom Out', 'Editor Font Zoom Reset'],
  ...
  'vs/editor/contrib/format/formatActions': ['Format Document', 'Format Selection'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['Click to show {0} definitions.'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['Loading...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} references', '{0} reference', 'References'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['no preview available', 'No results', 'References'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['Symbol {0} of {1}, {2} for next', 'Symbol {0} of {1}'],
  'vs/editor/contrib/hover/hover': ['Show Hover', 'Show Definition Preview Hover'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['Replace with Previous Value', 'Replace with Next Value'],
  ...
  'vs/editor/contrib/message/messageController': ['Cannot edit in read-only editor'],
  ...
  'vs/editor/contrib/parameterHints/parameterHints': ['Trigger Parameter Hints'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['Developer: Force Retokenize'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['global commands', 'editor commands', '{0}, {1}'],
