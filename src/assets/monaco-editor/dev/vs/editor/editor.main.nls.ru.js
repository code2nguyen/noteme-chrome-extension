...
define('vs/editor/editor.main.nls.ru', {
  ...
  'vs/base/browser/ui/findinput/findInput': ['входные данные'],
  'vs/base/browser/ui/findinput/findInputCheckboxes': [
    'С учетом регистра',
    'Слово целиком',
    'Использовать регулярное выражение',
  ],
  'vs/base/browser/ui/findinput/replaceInput': ['входные данные', 'Сохранить регистр'],
  'vs/base/browser/ui/inputbox/inputBox': ['Ошибка: {0}', 'Предупреждение: {0}', 'Информация: {0}'],
  'vs/base/browser/ui/keybindingLabel/keybindingLabel': ['свободный'],
  ...
  'vs/base/parts/quickinput/browser/quickInputList': ['Быстрый ввод'],
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['Количество курсоров ограничено {0}.'],
  ...
  'vs/editor/common/config/editorOptions': [
    ...
    'Управляет условием автоматического включения поиска в выделенном фрагменте.',
    ...
    'Настраивает лигатуры или функции шрифтов.',
  ...
  'vs/editor/common/model/editStack': ['Ввод'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['Показать команды CodeLens для текущей строки'],
  ...
  'vs/editor/contrib/contextmenu/contextmenu': ['Показать контекстное меню редактора'],
  'vs/editor/contrib/cursorUndo/cursorUndo': ['Отмена действия курсора', 'Повтор действия курсора'],
  ...
  'vs/editor/contrib/format/formatActions': ['Форматировать документ', 'Форматировать выделенный фрагмент'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['Щелкните, чтобы отобразить определения ({0}).'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['Загрузка...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['Ссылок: {0}', '{0} ссылка', 'Ссылки'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['Символ {0} из {1}, {2} для следующего', 'Символ {0} из {1}'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['Заменить предыдущим значением', 'Заменить следующим значением'],
  ...
  'vs/editor/contrib/message/messageController': ['Не удается выполнить изменение в редакторе только для чтения'],
  ...
  'vs/editor/contrib/parameterHints/parameterHints': ['Переключить подсказки к параметрам'],
  'vs/editor/contrib/parameterHints/parameterHintsWidget': ['{0}, указание'],
  ...
  'vs/editor/contrib/rename/onTypeRename': [
    'На символе переименования типа',
  ...
  'vs/editor/contrib/tokenization/tokenization': ['Разработчик: принудительная повторная установка токенов'],
  'vs/editor/contrib/unusualLineTerminators/unusualLineTerminators': [
    ...
    'Этот файл содержит один или несколько необычных символов завершения строки, таких как разделитель строк (LS) или разделитель абзацев (PS).\r\n\r\nРекомендуется удалить их из файла. Удаление этих символов можно настроить с помощью параметра "editor.unusualLineTerminators".',
    'Исправить этот файл',
    'Игнорировать проблему для этого файла',
  ],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['глобальные команды', 'команды редактора', '{0}, {1}'],
  ...
  'vs/platform/undoRedo/common/undoRedoService': [
    ...
    'Не удалось повторить действие "{0}" для всех файлов, так как в {1} уже выполняется операция отмены или повтора действия',
