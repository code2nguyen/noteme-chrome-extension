...
define('vs/editor/editor.main.nls.de', {
  ...
  'vs/base/browser/ui/findinput/replaceInput': ['Eingabe', 'Groß-/Kleinschreibung beibehalten'],
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['Die Anzahl der Cursors wurde auf {0} beschränkt.'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['CodeLens-Befehle für aktuelle Zeile anzeigen'],
  ...
  'vs/editor/contrib/cursorUndo/cursorUndo': ['Mit Cursor rückgängig machen', 'Wiederholen mit Cursor'],
  ...
  'vs/editor/contrib/format/formatActions': ['Dokument formatieren', 'Auswahl formatieren'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['Klicken Sie, um {0} Definitionen anzuzeigen.'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['Wird geladen...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} Verweise', '{0} Verweis', 'Verweise'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['Keine Vorschau verfügbar.', 'Keine Ergebnisse', 'Verweise'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['Symbol {0} von {1}, {2} für nächstes', 'Symbol {0} von {1}'],
  'vs/editor/contrib/hover/hover': ['Hovern anzeigen', 'Definitionsvorschauhover anzeigen'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['Durch vorherigen Wert ersetzen', 'Durch nächsten Wert ersetzen'],
  ...
  'vs/editor/contrib/message/messageController': ['Ein Bearbeiten ist im schreibgeschützten Editor nicht möglich'],
  ...
  'vs/editor/contrib/parameterHints/parameterHints': ['Parameterhinweise auslösen'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['Entwickler: Force Retokenize'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['Globale Befehle', 'Editor-Befehle', '{0}, {1}'],
