...
define('vs/editor/editor.main.nls.ko', {
  ...
  'vs/base/parts/quickinput/browser/quickInputList': ['빠른 입력'],
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['커서 수는 {0}(으)로 제한되었습니다.'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['현재 줄에 대한 코드 렌즈 명령 표시'],
  ...
  'vs/editor/contrib/fontZoom/fontZoom': ['편집기 글꼴 확대', '편집기 글꼴 축소', '편집기 글꼴 확대/축소 다시 설정'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['{0}개 정의를 표시하려면 클릭하세요.'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['로드 중...', '{0}({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['참조 {0}개', '참조 {0}개', '참조'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['미리 보기를 사용할 수 없음', '결과 없음', '참조'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['{1}의 {0} 기호, 다음의 경우 {2}', '{1}의 기호 {0}'],
  'vs/editor/contrib/hover/hover': ['가리키기 표시', '정의 미리 보기 가리킨 항목 표시'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['이전 값으로 바꾸기', '다음 값으로 바꾸기'],
  ...
  'vs/editor/contrib/message/messageController': ['읽기 전용 편집기에서는 편집할 수 없습니다.'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['전역 명령', '편집기 명령', '{0}, {1}'],
