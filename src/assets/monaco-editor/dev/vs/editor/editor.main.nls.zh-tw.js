...
define('vs/editor/editor.main.nls.zh-tw', {
  ...
  'vs/base/parts/quickinput/browser/quickInputList': ['快速輸入'],
  'vs/editor/browser/controller/coreCommands': ['即使行的長度過長，仍要堅持至結尾', '即使行的長度過長，仍要堅持至結尾'],
  'vs/editor/browser/controller/textAreaHandler': ['編輯器', '目前無法存取此編輯器。請按 {0} 取得選項。'],
  'vs/editor/browser/editorExtensions': ['復原(&&U)', '復原', '取消復原(&&R)', '重做', '全選(&&S)', '全選'],
  ...
  'vs/editor/contrib/caretOperations/caretOperations': ['將所選文字向左移動', '將所選文字向右移動'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['顯示目前行的 Code Lens 命令'],
  ...
  'vs/editor/contrib/fontZoom/fontZoom': ['編輯器字體放大', '編輯器字型縮小', '編輯器字體重設縮放'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['按一下以顯示 {0} 項定義。'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['正在載入...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} 個參考', '{0} 個參考', '參考'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['無法預覽', '查無結果', '參考'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['{1} 的符號 {0}，{2} 為下一個', '{1} 的符號 {0}'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['以上一個值取代', '以下一個值取代'],
  ...
  'vs/editor/contrib/rename/onTypeRename': ['依類型重新命名符號', '當編輯器自動重新命名類型時的背景色彩。'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['全域命令', '編輯器命令', '{0}, {1}'],
