...
define('vs/editor/editor.main.nls.ja', {
  ...
  'vs/base/browser/ui/findinput/replaceInput': ['入力', '保持する'],
  'vs/base/browser/ui/inputbox/inputBox': ['エラー: {0}', '警告: {0}', '情報: {0}'],
  'vs/base/browser/ui/keybindingLabel/keybindingLabel': ['バインドなし'],
  ...
  'vs/base/parts/quickinput/browser/quickInputList': ['クイック入力'],
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['カーソルの数は {0} 個に制限されています。'],
  ...
  'vs/editor/common/model/editStack': ['入力しています'],
  ...
  'vs/editor/contrib/caretOperations/caretOperations': ['選択したテキストを左に移動', '選択したテキストを右に移動'],
  ...
  'vs/editor/contrib/contextmenu/contextmenu': ['エディターのコンテキスト メニューの表示'],
  'vs/editor/contrib/cursorUndo/cursorUndo': ['カーソルを元に戻す', 'カーソルのやり直し'],
  ...
  'vs/editor/contrib/format/formatActions': ['ドキュメントのフォーマット', '選択範囲のフォーマット'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['クリックして、{0} の定義を表示します。'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['読み込んでいます...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} 個の参照', '{0} 個の参照', '参照'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['{1} のシンボル {0}、次に {2}', 'シンボル {0}/{1}'],
  'vs/editor/contrib/hover/hover': ['ホバーの表示', '定義プレビューのホバーを表示する'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['前の値に置換', '次の値に置換'],
  ...
  'vs/editor/contrib/parameterHints/parameterHints': ['パラメーター ヒントをトリガー'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['開発者: トークン再作成の強制'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['グローバル コマンド', 'エディター コマンド', '{0}, {1}'],
