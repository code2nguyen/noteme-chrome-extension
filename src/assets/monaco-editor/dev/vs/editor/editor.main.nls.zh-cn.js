...
define('vs/editor/editor.main.nls.zh-cn', {
  ...
  'vs/base/parts/quickinput/browser/quickInputList': ['快速输入'],
  'vs/editor/browser/controller/coreCommands': ['即使转到较长的行，也一直到末尾', '即使转到较长的行，也一直到末尾'],
  'vs/editor/browser/controller/textAreaHandler': ['编辑器', '现在无法访问编辑器。按 {0} 获取选项。'],
  'vs/editor/browser/editorExtensions': ['撤消(&&U)', '撤消', '恢复(&&R)', '恢复', '全选(&&S)', '选择全部'],
  'vs/editor/browser/widget/codeEditorWidget': ['光标数量被限制为 {0}。'],
  ...
  'vs/editor/contrib/caretOperations/caretOperations': ['向左移动所选文本', '向右移动所选文本'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['显示当前行的 Code Lens 命令'],
  ...
  'vs/editor/contrib/cursorUndo/cursorUndo': ['光标撤消', '光标重做'],
  ...
  'vs/editor/contrib/fontZoom/fontZoom': ['放大编辑器字体', '缩小编辑器字体', '重置编辑器字体大小'],
  ...
  'vs/editor/contrib/format/formatActions': ['格式化文档', '格式化选定内容'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['单击显示 {0} 个定义。'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['正在加载...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} 个引用', '{0} 个引用', '引用'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['无可用预览', '无结果', '引用'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['{1} 的符号 {0}，下一个使用 {2}', '{1} 的符号 {0}'],
  'vs/editor/contrib/hover/hover': ['显示悬停', '显示定义预览悬停'],
  ...
  'vs/editor/contrib/inPlaceReplace/inPlaceReplace': ['替换为上一个值', '替换为下一个值'],
  ...
  'vs/editor/contrib/message/messageController': ['无法在只读编辑器中编辑'],
  ...
  'vs/editor/contrib/rename/onTypeRename': ['在键入时重命名符号', '编辑器根据类型自动重命名时的背景色。'],
  ...
  'vs/editor/contrib/smartSelect/smartSelect': ['展开选择', '展开选定内容(&&E)', '收起选择', '缩小选定范围(&&S)'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['开发人员: 强制重新进行标记'],
  ...
  'vs/platform/quickinput/browser/commandsQuickAccess': ['{0}, {1}', '最近使用', '其他命令', '命令"{0}"导致错误 ({1})'],
  'vs/platform/quickinput/browser/helpQuickAccess': ['全局命令', '编辑器命令', '{0}, {1}'],
