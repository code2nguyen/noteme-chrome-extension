...
define('vs/editor/editor.main.nls.fr', {
  ...
  'vs/base/browser/ui/inputbox/inputBox': ['Erreur : {0}', 'Avertissement : {0}', 'Info : {0}'],
  ...
  'vs/base/parts/quickinput/browser/quickInputList': ['Entrée rapide'],
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['Le nombre de curseurs a été limité à {0}.'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['Afficher les commandes Code Lens de la ligne actuelle'],
  ...
  'vs/editor/contrib/contextmenu/contextmenu': ["Afficher le menu contextuel de l'éditeur"],
  'vs/editor/contrib/cursorUndo/cursorUndo': ['Annulation du curseur', 'Restauration du curseur'],
  ...
  'vs/editor/contrib/format/formatActions': ['Mettre le document en forme', 'Mettre la sélection en forme'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['Cliquez pour afficher {0} définitions.'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['Chargement en cours...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} références', '{0} référence', 'Références'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['aperçu non disponible', 'Aucun résultat', 'Références'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['Symbole {0} sur {1}, {2} pour le suivant', 'Symbole {0} sur {1}'],
  'vs/editor/contrib/hover/hover': ['Afficher par pointage', "Afficher le pointeur de l'aperçu de définition"],
  ...
  'vs/editor/contrib/message/messageController': ['Impossible de modifier dans l’éditeur en lecture seule'],
  ...
  'vs/editor/contrib/parameterHints/parameterHints': ['Indicateurs des paramètres Trigger'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['Développeur : forcer la retokenisation'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['commandes globales', "commandes de l'éditeur", '{0}, {1}'],
  ...
  'vs/platform/undoRedo/common/undoRedoService': [
    ...
    "Impossible de rétablir '{0}' dans tous les fichiers, car une opération d'annulation ou de rétablissement est déjà en cours d'exécution sur {1}",
