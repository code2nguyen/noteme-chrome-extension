...
define('vs/editor/editor.main.nls.it', {
  ...
  'vs/editor/browser/widget/codeEditorWidget': ['Il numero di cursori è stato limitato a {0}.'],
  ...
  'vs/editor/contrib/codelens/codelensController': ['Mostra comandi di CodeLens per la riga corrente'],
  ...
  'vs/editor/contrib/contextmenu/contextmenu': ['Mostra il menu di scelta rapida editor'],
  'vs/editor/contrib/cursorUndo/cursorUndo': ['Cursore - Annulla', 'Cursore - Ripeti'],
  ...
  'vs/editor/contrib/format/formatActions': ['Formatta documento', 'Formatta selezione'],
  ...
  'vs/editor/contrib/gotoSymbol/link/goToDefinitionAtPosition': ['Fare clic per visualizzare {0} definizioni.'],
  'vs/editor/contrib/gotoSymbol/peek/referencesController': ['Caricamento...', '{0} ({1})'],
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['{0} riferimenti', '{0} riferimento', 'Riferimenti'],
  ...
  'vs/editor/contrib/gotoSymbol/symbolNavigation': ['Simbolo {0} di {1}, {2} per il successivo', 'Simbolo {0} di {1}'],
  ...
  'vs/editor/contrib/message/messageController': ["Non è possibile modificare nell'editor di sola lettura"],
  ...
  'vs/editor/contrib/parameterHints/parameterHints': ['Attiva i suggerimenti per i parametri'],
  'vs/editor/contrib/parameterHints/parameterHintsWidget': ['{0}, suggerimento'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['Sviluppatore: Forza retokenizzazione'],
  ...
  'vs/platform/quickinput/browser/helpQuickAccess': ['comandi globali', "comandi dell'editor", '{0}, {1}'],
  ...
  'vs/platform/undoRedo/common/undoRedoService': [
    ...
    "Non è stato possibile ripetere '{0}' su tutti i file perché è già in esecuzione un'operazione di annullamento o ripetizione su {1}",
