 ...
 *--------------------------------------------------------------------------------------------*/
define('vs/basic-languages/typescript/typescript', ['require', 'exports', '../fillers/monaco-editor-core'], function (
  require,
  exports,
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define('vs/basic-languages/javascript/javascript', ['require', 'exports', '../typescript/typescript'], function (
  require,
  exports,
  typescript_1
) {
