...
var TypeScriptWorker = /** @class */ (function () {
  ...
  TypeScriptWorker.prototype.findRenameLocations = function (
    fileName,
    position,
    findInStrings,
    findInComments,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        try {
          return [
            2 /*return*/,
            this._languageService.getCodeFixesAtPosition(fileName, start, end, errorCodes, formatOptions, preferences),
          ];
        } catch (_b) {
          return [2 /*return*/, []];
        }
