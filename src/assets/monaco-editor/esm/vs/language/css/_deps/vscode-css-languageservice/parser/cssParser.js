...
var Parser = /** @class */ (function () {
  ...
  Parser.prototype._parseRuleSetDeclaration = function () {
    ...
    return this._tryParseCustomPropertyDeclaration() || this._parseDeclaration();
  };
  /**
  ...
  Parser.prototype._parseDeclaration = function (resyncStopTokens) {
    ...
    if (!this.accept(TokenType.Colon)) {
      var stopTokens = resyncStopTokens
        ? __spreadArrays(resyncStopTokens, [TokenType.SemiColon])
        : [TokenType.SemiColon];
