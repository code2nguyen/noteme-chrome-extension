...
var CSSDataManager = /** @class */ (function () {
  function CSSDataManager(options) {
    ...
    this.setDataProviders(
      (options === null || options === void 0 ? void 0 : options.useDefaultDataProvider) !== false,
      (options === null || options === void 0 ? void 0 : options.customDataProviders) || []
    );
  }
