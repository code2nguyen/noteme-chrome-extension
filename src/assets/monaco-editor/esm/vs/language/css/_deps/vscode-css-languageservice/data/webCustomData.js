...
export var cssData = {
  ...
  properties: [
    ...
    },
    {
      ...
      browsers: ['E79', 'FF41', 'S10.1', 'C57', 'O44'],
      values: [
        {
          name: 'none',
          description: 'No limit on the height of the box.',
    ...
    },
    {
      ...
      browsers: ['E79', 'FF41', 'S5.1', 'C48', 'O15'],
      values: [
        {
          name: 'sideways',
          browsers: ['E79', 'FF41', 'S5.1', 'C48', 'O15'],
    ...
    },
    {
      ...
      relevance: 50,
      browsers: ['E84', 'FF63', 'S10.1', 'C84', 'O70'],
      description:
