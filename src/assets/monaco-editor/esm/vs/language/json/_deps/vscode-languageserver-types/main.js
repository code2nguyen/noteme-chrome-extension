...
(function (Color) {
  ...
  function is(value) {
    var candidate = value;
    return (
      Is.number(candidate.red) && Is.number(candidate.green) && Is.number(candidate.blue) && Is.number(candidate.alpha)
    );
  }
  Color.is = is;
})(Color || (Color = {}));
...
(function (VersionedTextDocumentIdentifier) {
  ...
  function is(value) {
    var candidate = value;
    return (
      Is.defined(candidate) && Is.string(candidate.uri) && (candidate.version === null || Is.number(candidate.version))
    );
  }
