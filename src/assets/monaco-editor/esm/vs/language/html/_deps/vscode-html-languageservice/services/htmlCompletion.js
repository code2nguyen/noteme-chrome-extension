...
import {
  ...
  InsertTextFormat,
  MarkupKind,
} from '../_deps/vscode-languageserver-types/main.js';
...
var HTMLCompletion = /** @class */ (function () {
  ...
  HTMLCompletion.prototype._doComplete = function (document, position, htmlDocument, settings) {
    ...
    function collectAttributeNameSuggestions(nameStart, nameEnd) {
      ...
      var value = isFollowedBy(text, nameEnd, ScannerState.AfterAttributeName, TokenType.DelimiterAssign)
        ? ''
        : '="$1"';
  ...
  HTMLCompletion.prototype.doesSupportMarkdown = function () {
    ...
    if (!isDefined(this.supportsMarkdown)) {
      ...
      this.supportsMarkdown =
        Array.isArray(documentationFormat) && documentationFormat.indexOf(MarkupKind.Markdown) !== -1;
    }
    return this.supportsMarkdown;
  };
