...
export const WorkbenchListAutomaticKeyboardNavigation = new RawContextKey(
...
let WorkbenchList = class WorkbenchList extends List {
  constructor(
    ...
    const [workbenchListOptions, workbenchListOptionsDisposable] = toWorkbenchListOptions(
      options,
      configurationService,
      keybindingService
    );
    super(
      ...
      Object.assign(
        Object.assign(
          Object.assign({ keyboardSupport: false }, computeStyles(themeService.getColorTheme(), defaultListStyles)),
...
class ResourceNavigator extends Disposable {
  constructor(widget, options) {
    ...
    this.openOnFocus =
      (_a = options === null || options === void 0 ? void 0 : options.openOnFocus) !== null && _a !== void 0
        ? _a
        : false;
    this._register(
      Event.filter(
    ...
    if (
      typeof (options === null || options === void 0 ? void 0 : options.openOnSingleClick) !== 'boolean' &&
      (options === null || options === void 0 ? void 0 : options.configurationService)
    ) {
      ...
      this.openOnSingleClick =
        (_b = options === null || options === void 0 ? void 0 : options.openOnSingleClick) !== null && _b !== void 0
          ? _b
          : true;
    }
  }
  onFocusFromKeyboard(event) {
    ...
    const preserveFocus =
      typeof event.browserEvent.preserveFocus === 'boolean' ? event.browserEvent.preserveFocus : true;
    const pinned = false;
...
let WorkbenchObjectTree = class WorkbenchObjectTree extends ObjectTree {
  constructor(
    ...
    const { options: treeOptions, getAutomaticKeyboardNavigation, disposable } = workbenchTreeDataPreamble(
      container,
      options,
      contextKeyService,
      configurationService,
