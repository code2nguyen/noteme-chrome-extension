  ...
  getPicks(filter, disposables, token) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (const commandPick of allCommandPicks) {
        const labelHighlights = withNullAsUndefined(
          AbstractCommandsQuickAccessProvider.WORD_FILTER(filter, commandPick.label)
        );
        const aliasHighlights = commandPick.commandAlias
          ? withNullAsUndefined(AbstractCommandsQuickAccessProvider.WORD_FILTER(filter, commandPick.commandAlias))
          : undefined;
      ...
      for (let i = 0; i < filteredCommandPicks.length; i++) {
        ...
        // Command
        commandPicks.push(
          Object.assign(Object.assign({}, commandPick), {
            ariaLabel,
            detail:
              this.options.showAlias && commandPick.commandAlias !== commandPick.label
...
let CommandsHistory = class CommandsHistory extends Disposable {
  ...
  static getConfiguredCommandHistoryLength(configurationService) {
    ...
    const configuredCommandHistoryLength =
      (_b = (_a = config.workbench) === null || _a === void 0 ? void 0 : _a.commandPalette) === null || _b === void 0
        ? void 0
        : _b.history;
...
CommandsHistory = __decorate(
  [__param(0, IStorageService), __param(1, IConfigurationService), __param(2, IStorageKeysSyncRegistryService)],
  CommandsHistory
);
