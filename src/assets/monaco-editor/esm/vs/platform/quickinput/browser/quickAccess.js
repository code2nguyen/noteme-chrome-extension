...
let QuickAccessController = class QuickAccessController extends Disposable {
  ...
  show(value = '', options) {
    ...
    const visibleDescriptor =
      visibleQuickAccess === null || visibleQuickAccess === void 0 ? void 0 : visibleQuickAccess.descriptor;
    ...
    if (
      typeof (options === null || options === void 0 ? void 0 : options.itemActivation) === 'number' ||
      (options === null || options === void 0 ? void 0 : options.quickNavigateConfiguration)
    ) {
      picker.itemActivation =
        (_a = options === null || options === void 0 ? void 0 : options.itemActivation) !== null && _a !== void 0
          ? _a
  ...
  adjustValueSelection(picker, descriptor, options) {
    ...
    // Otherwise: select the value up until the prefix
      ...
      valueSelection = [
        (_a = descriptor === null || descriptor === void 0 ? void 0 : descriptor.prefix.length) !== null &&
        _a !== void 0
          ? _a
          : 0,
        picker.value.length,
...
QuickAccessController = __decorate(
  [__param(0, IQuickInputService), __param(1, IInstantiationService)],
