...
} from '../../common/services/textResourceConfigurationService.js';
import {
...
} from '../../../platform/userDataSync/common/storageKeys.js';
...
(function (StaticServices) {
  ...
  StaticServices.instantiationService = define(IInstantiationService, () =>
  ...
  StaticServices.resourceConfigurationService = define(ITextResourceConfigurationService, () =>
    new SimpleResourceConfigurationService(configurationServiceImpl));
  StaticServices.resourcePropertiesService = define(ITextResourcePropertiesService, () =>
  ...
  StaticServices.undoRedoService = define(IUndoRedoService, (o) =>
    new UndoRedoService(StaticServices.dialogService.get(o), StaticServices.notificationService.get(o)));
  StaticServices.modelService = define(IModelService, (o) =>
  ...
  StaticServices.markerDecorationsService = define(IMarkerDecorationsService, (o) =>
    new MarkerDecorationsService(StaticServices.modelService.get(o), StaticServices.markerService.get(o)));
  StaticServices.codeEditorService = define(ICodeEditorService, (o) =>
    new StandaloneCodeEditorServiceImpl(StaticServices.standaloneThemeService.get(o)));
  ...
  StaticServices.storageSyncService = define(IStorageKeysSyncRegistryService, () =>
    new StorageKeysSyncRegistryService());
  StaticServices.editorWorkerService = define(IEditorWorkerService, (o) =>
...
export class DynamicStandaloneServices extends Disposable {
  constructor(domElement, overrides) {
    ...
    let layoutService = ensure(
      ILayoutService,
      () => new SimpleLayoutService(StaticServices.codeEditorService.get(ICodeEditorService), domElement)
    );
    ensure(
      IQuickInputService,
      () =>
