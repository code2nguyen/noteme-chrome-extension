...
let RenameController = class RenameController {
  constructor(
    ...
    this._renameInputField = this._dispoableStore.add(
      new IdleValue(() =>
        this._dispoableStore.add(
          this._instaService.createInstance(RenameInputField, this.editor, [
            'acceptRenameInput',
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        MessageController.get(this.editor).showMessage(
          e || nls.localize('resolveRenameLocationFailed', 'An unknown error occurred while resolving rename location'),
          position
        );
        return undefined;
      }
      ...
      const inputFieldResult = yield this._renameInputField.value.getInput(
        loc.range,
        loc.text,
        selectionStart,
        selectionEnd,
      ...
      const renameOperation = raceCancellation(
        skeleton.provideRenameEdits(inputFieldResult.newName, this._cts.token),
        this._cts.token
      ).then(
        (renameResult) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            this._bulkEditService
              .apply(ResourceEdit.convert(renameResult), {
                editor: this.editor,
                ...
                quotableLabel: nls.localize(
                  'quotableLabel',
                  'Renaming {0}',
                  loc === null || loc === void 0 ? void 0 : loc.text
                ),
              })
              .then((result) => {
