...
let RenameInputField = class RenameInputField {
  ...
  getDomNode() {
    if (!this._domNode) {
      ...
      this._input.setAttribute(
        'aria-label',
        localize('renameAriaLabel', 'Rename input. Type new name and press Enter to commit.')
      );
      ...
      const updateLabel = () => {
        ...
        this._label.innerText = localize(
          { key: 'label', comment: ['placeholders are keybindings, e.g "F2 to Rename, Shift+F2 to Preview"'] },
          '{0} to Rename, {1} to Preview',
          (_a = this._keybindingService.lookupKeybinding(accept)) === null || _a === void 0 ? void 0 : _a.getLabel(),
          (_b = this._keybindingService.lookupKeybinding(preview)) === null || _b === void 0 ? void 0 : _b.getLabel()
        );
      };
      updateLabel();
  ...
  _updateStyles(theme) {
    ...
    this._domNode.style.backgroundColor = String(
      (_a = theme.getColor(editorWidgetBackground)) !== null && _a !== void 0 ? _a : ''
    );
    ...
    this._input.style.borderColor =
      (_d = border === null || border === void 0 ? void 0 : border.toString()) !== null && _d !== void 0 ? _d : 'none';
  }
  _updateFont() {
...
RenameInputField = __decorate(
  [__param(2, IThemeService), __param(3, IKeybindingService), __param(4, IContextKeyService)],
  RenameInputField
);
