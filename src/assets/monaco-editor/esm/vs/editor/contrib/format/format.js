...
} from '../../browser/core/editorState.js';
...
export function formatDocumentRangesWithSelectedProvider(
  accessor,
  editorOrModel,
  rangeOrRanges,
  mode,
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (selected) {
      ...
      yield instaService.invokeFunction(
...
export function formatDocumentRangesWithProvider(accessor, provider, editorOrModel, rangeOrRanges, token) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (let range of ranges) {
      try {
        const rawEdits = yield provider.provideDocumentRangeFormattingEdits(
          model,
          range,
...
export function getDocumentRangeFormattingEditsUntilResult(workerService, model, range, options, token) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const provider of providers) {
      let rawEdits = yield Promise.resolve(
...
export function getDocumentFormattingEditsUntilResult(workerService, model, options, token) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const provider of providers) {
      let rawEdits = yield Promise.resolve(provider.provideDocumentFormattingEdits(model, options, token)).catch(
...
export function getOnTypeFormattingEdits(workerService, model, position, ch, options) {
  ...
  return Promise.resolve(
    providers[0].provideOnTypeFormattingEdits(model, position, ch, options, CancellationToken.None)
  )
    .catch(onUnexpectedExternalError)
    .then((edits) => {
