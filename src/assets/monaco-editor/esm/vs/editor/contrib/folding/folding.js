      ...
      this.editor.onDidChangeConfiguration((e) => {
        ...
        if (e.hasChanged(91 /* showFoldingControls */) || e.hasChanged(33 /* foldingHighlight */)) {
          ...
          this.foldingDecorationProvider.autoHideFoldingControls =
            options.get(91 /* showFoldingControls */) === 'mouseover';
          this.foldingDecorationProvider.showFoldingHighlights = options.get(33 /* foldingHighlight */);
  ...
  getRangeProvider(editorModel) {
    ...
    if (this._useFoldingProviders && this.foldingModel) {
      ...
      if (foldingProviders.length === 0 && this.foldingStateMemento && this.foldingStateMemento.collapsedRegions) {
        const rangeProvider = (this.rangeProvider = new InitializingRangeProvider(
          editorModel,
    ...
    if (this.updateScheduler) {
      ...
      this.foldingModelPromise = this.updateScheduler
        .trigger(() => {
          ...
          let foldingRegionPromise = (this.foldingRegionPromise = createCancelablePromise((token) =>
...
function foldingArgumentsConstraint(args) {
  if (!types.isUndefined(args)) {
    ...
    if (
      ...
      (!types.isArray(foldingArgs.selectionLines) || !foldingArgs.selectionLines.every(types.isNumber))
    ) {
      return false;
    }
  }
...
export const foldBackgroundBackground = registerColor(
  ...
  { light: transparent(editorSelectionBackground, 0.3), dark: transparent(editorSelectionBackground, 0.3), hc: null },
  nls.localize(
