        ...
        while (k < index) {
          ...
          if (endLineNumber <= dirtyRegionEndLine) {
            accessor.changeDecorationOptions(
              ...
              this._decorationProvider.getDecorationOption(isCollapsed, endLineNumber <= lastHiddenLine)
            );
          }
    ...
    for (let i = 0; i < this._regions.length; i++) {
      if (this._regions.isCollapsed(i)) {
        ...
        if (range) {
          ...
          let endLineNumber =
            range.endLineNumber + this._regions.getEndLineNumber(i) - this._regions.getStartLineNumber(i);
