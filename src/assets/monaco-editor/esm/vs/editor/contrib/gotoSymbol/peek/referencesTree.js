...
let StringRepresentationProvider = class StringRepresentationProvider {
  ...
  getKeyboardNavigationLabel(element) {
    ...
    if (element instanceof OneReference) {
      const parts =
        (_a = element.parent.getPreview(element)) === null || _a === void 0 ? void 0 : _a.preview(element.range);
      if (parts) {
        return parts.value;
      }
    }
...
let FileReferencesTemplate = class FileReferencesTemplate extends Disposable {
  ...
  set(element, matches) {
    ...
    this.file.setLabel(getBaseLabel(element.uri), this._uriLabel.getUriLabel(parent, { relative: true }), {
