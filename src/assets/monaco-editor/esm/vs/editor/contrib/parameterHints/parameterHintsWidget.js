...
let ParameterHintsWidget = class ParameterHintsWidget extends Disposable {
  ...
  render(hints) {
    ...
    const activeParameterIndex =
      (_a = signature.activeParameter) !== null && _a !== void 0 ? _a : hints.activeParameter;
    if (!hasParameters) {
    ...
    if (activeParameter === null || activeParameter === void 0 ? void 0 : activeParameter.documentation) {
      ...
      if (typeof activeParameter.documentation === 'string') {
        ...
        const renderedContents = this.renderDisposeables.add(
          this.markdownRenderer.render(activeParameter.documentation)
        );
...
ParameterHintsWidget = __decorate(
  [__param(1, IContextKeyService), __param(2, IOpenerService), __param(3, IModeService)],
...
registerThemingParticipant((theme, collector) => {
  ...
  if (border) {
    ...
    collector.addRule(
      `.monaco-editor .parameter-hints-widget.multiple .body { border-left: 1px solid ${border.transparent(0.5)}; }`
    );
    collector.addRule(
