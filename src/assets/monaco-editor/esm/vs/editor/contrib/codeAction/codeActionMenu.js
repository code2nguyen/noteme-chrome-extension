...
let CodeActionMenu = class CodeActionMenu extends Disposable {
  ...
  getMenuActions(trigger, actionsToShow, documentation) {
    var _a, _b;
    const toCodeActionAction = (action) =>
            ...
            ...provider._getAdditionalMenuItems(
              {
                ...
                only:
                  (_b = (_a = trigger.filter) === null || _a === void 0 ? void 0 : _a.include) === null || _b === void 0
                    ? void 0
                    : _b.value,
              },
              actionsToShow
