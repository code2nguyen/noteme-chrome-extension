...
let SuggestMemoryService = class SuggestMemoryService {
  ...
  _withStrategy(model, pos) {
    ...
    const mode = this._configService.getValue('editor.suggestSelection', {
      overrideIdentifier:
        (_a = this._modeService.getLanguageIdentifier(model.getLanguageIdAtPosition(pos.lineNumber, pos.column))) ===
          null || _a === void 0
          ? void 0
          : _a.language,
      resource: model.uri,
...
SuggestMemoryService = __decorate(
  [__param(0, IStorageService), __param(1, IModeService), __param(2, IConfigurationService)],
