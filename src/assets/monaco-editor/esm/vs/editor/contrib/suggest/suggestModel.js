...
export class SuggestModel {
  ...
  _updateTriggerCharacters() {
    ...
    const checkTriggerCharacter = (text) => {
      ...
      if (supports) {
        ...
        const items = (_a = this._completionModel) === null || _a === void 0 ? void 0 : _a.adopt(supports);
        this.trigger(
  ...
  _onCursorChange(e) {
    ...
    if (this._state === 0 /* Idle */) {
      ...
      if (
        this._editor.getOption(96 /* suggest */).snippetsPreventQuickSuggestions &&
      ...
      this._triggerQuickSuggest.cancelAndSet(() => {
        ...
        if (quickSuggestions === false) {
          ...
          const inValidScope =
            (quickSuggestions.other && tokenType === 0) /* Other */ ||
      ...
      .then(([completions, wordDistance]) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          this._completionModel = new CompletionModel(
            ...
            wordDistance,
            this._editor.getOption(96 /* suggest */),
            this._editor.getOption(93 /* snippetSuggestions */),
            clipboardText
          );
  ...
  _onNewContext(ctx) {
    ...
    if (
      ...
      this.trigger(
        { auto: this._state === 2 /* Auto */, shy: false, triggerKind: 2 /* TriggerForIncompleteCompletions */ },
        true,
        incomplete,
        adopted
      );
