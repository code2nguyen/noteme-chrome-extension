...
export class MoveLinesCommand {
    ...
    if (s.startLineNumber === s.endLineNumber && model.getLineMaxColumn(s.startLineNumber) === 1) {
      ...
      if (this._isMovingDown) {
        ...
        if (this.shouldAutoIndent(model, s)) {
          let movingLineMatchResult = this.matchEnterRule(
            model,
            indentConverter,
            tabSize,
            movingLineNumber,
          ...
          if (movingLineMatchResult !== null) {
            ...
            let indentOfMovingLine = LanguageConfigurationRegistry.getGoodIndentForLine(
              this._autoIndent,
              virtualModel,
          ...
          if (ret !== null) {
            ...
            let newIndentatOfMovingBlock = LanguageConfigurationRegistry.getGoodIndentForLine(
              this._autoIndent,
              virtualModel,
              model.getLanguageIdAtPosition(movingLineNumber, 1),
              s.startLineNumber + 1,
  ...
  matchEnterRule(model, indentConverter, tabSize, line, oneLineAbove, oneLineAboveText) {
    ...
    let enter = LanguageConfigurationRegistry.getEnterAction(
      this._autoIndent,
      model,
