...
export class FindModelBoundToEditorModel {
  ...
  research(moveCursor, newFindScope) {
    ...
    if (moveCursor && this._editor.getOption(29 /* find */).cursorMoveOnType) {
  ...
  _moveToPrevMatch(before, isRecursed = false) {
    ...
    let prevMatch = model.findPreviousMatch(
      ...
      this._state.wholeWord ? this._editor.getOption(105 /* wordSeparators */) : null,
      false
    );
    ...
    if (nextMatch) {
      if (selection.equalsRange(nextMatch.range)) {
        ...
        this._decorations.setStartPosition(
          new Position(selection.startLineNumber, selection.startColumn + replaceString.length)
        );
        this.research(true);
      } else {
        this._decorations.setStartPosition(this._editor.getPosition());
