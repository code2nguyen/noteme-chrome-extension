...
let CommonFindController = class CommonFindController extends Disposable {
  ...
  getGlobalBufferTerm() {
    return __awaiter(this, void 0, void 0, function* () {
      if (
        this._editor.getOption(29 /* find */).globalFindClipboard &&
...
CommonFindController = __decorate(
  [__param(1, IContextKeyService), __param(2, IStorageService), __param(3, IClipboardService)],
...
let FindController = class FindController extends CommonFindController {
  constructor(
    ...
    _storageService,
    _storageKeysSyncRegistryService,
    clipboardService
  ) {
  ...
  _createFindWidget() {
    this._widget = this._register(
      new FindWidget(
        ...
        this._storageKeysSyncRegistryService
      )
    );
    this._findOptionsWidget = this._register(
      new FindOptionsWidget(this._editor, this._state, this._keybindingService, this._themeService)
    );
  }
};
      ...
      if (controller && !this._run(controller)) {
        yield controller.start({
          ...
          seedSearchStringFromSelection:
            ...
            editor.getOption(29 /* find */).seedSearchStringFromSelection,
  ...
  run(accessor, editor) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      /*
             ...
             */
      let shouldFocus =
        findInputFocused || seedSearchStringFromSelection ? 2 /* FocusReplaceInput */ : 1; /* FocusFindInput */
      if (controller) {
        yield controller.start({
