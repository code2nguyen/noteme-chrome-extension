...
class MessageWidget {
  constructor(parent, editor, onRelatedInformation, _openerService) {
    ...
    this._disposables.add(
      dom.addStandardDisposableListener(this._relatedBlock, 'click', (event) => {
  ...
  update(marker) {
    ...
    if (isNonEmptyArray(relatedInformation)) {
      ...
      for (const related of relatedInformation) {
        ...
        relatedResource.innerText = `${getBaseLabel(related.resource)}(${related.startLineNumber}, ${
          related.startColumn
        }): `;
...
let MarkerNavigationWidget = class MarkerNavigationWidget extends PeekViewWidget {
  constructor(editor, _themeService, _openerService, _menuService, instantiationService, _contextKeyService) {
...
export const editorMarkerNavigationInfo = registerColor(
