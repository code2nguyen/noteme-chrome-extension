...
class EditorEmptySelectionClipboard extends EditorBooleanOption {
  constructor() {
    super(26 /* emptySelectionClipboard */, 'emptySelectionClipboard', true, {
      description: nls.localize(
...
class EditorFind extends BaseEditorOption {
  ...
  validate(_input) {
    ...
    return {
      ...
      seedSearchStringFromSelection: EditorBooleanOption.boolean(
      ...
      autoFindInSelection:
        typeof _input.autoFindInSelection === 'boolean'
          ? _input.autoFindInSelection
            ? 'always'
            : 'never'
          : EditorStringEnumOption.stringSet(input.autoFindInSelection, this.defaultValue.autoFindInSelection, [
              'never',
              'always',
              'multiline',
            ]),
      globalFindClipboard: EditorBooleanOption.boolean(
...
class EditorGoToLocation extends BaseEditorOption {
  ...
  validate(_input) {
    ...
    const input = _input;
    return {
      multiple: EditorStringEnumOption.stringSet(input.multiple, this.defaultValue.multiple, [
        'peek',
        'gotoAndPeek',
        'goto',
      ]),
      multipleDefinitions:
        (_a = input.multipleDefinitions) !== null && _a !== void 0
          ? _a
          : EditorStringEnumOption.stringSet(input.multipleDefinitions, 'peek', ['peek', 'gotoAndPeek', 'goto']),
      multipleTypeDefinitions:
        (_b = input.multipleTypeDefinitions) !== null && _b !== void 0
          ? _b
          : EditorStringEnumOption.stringSet(input.multipleTypeDefinitions, 'peek', ['peek', 'gotoAndPeek', 'goto']),
      multipleDeclarations:
        (_c = input.multipleDeclarations) !== null && _c !== void 0
          ? _c
          : EditorStringEnumOption.stringSet(input.multipleDeclarations, 'peek', ['peek', 'gotoAndPeek', 'goto']),
      multipleImplementations:
        (_d = input.multipleImplementations) !== null && _d !== void 0
          ? _d
          : EditorStringEnumOption.stringSet(input.multipleImplementations, 'peek', ['peek', 'gotoAndPeek', 'goto']),
      multipleReferences:
        (_e = input.multipleReferences) !== null && _e !== void 0
          ? _e
          : EditorStringEnumOption.stringSet(input.multipleReferences, 'peek', ['peek', 'gotoAndPeek', 'goto']),
...
export class EditorLayoutInfoComputer extends ComputedEditorOption {
      ...
      if (ratio > 1) {
        ...
        if (minimapSize === 'fill' || fitBecomesFill) {
          ...
          minimapCanvasInnerHeight = Math.ceil(
            Math.max(typicalViewportLineCount, viewLineCount + extraLinesBeyondLastLine) * minimapLineHeight
          );
          if (isViewportWrapping && fitBecomesFill) {
  ...
  static computeLayout(options, env) {
    ...
    const viewportColumn = Math.max(
      1,
      Math.floor((contentWidth - verticalScrollbarWidth - 2) / typicalHalfwidthCharacterWidth)
    );
...
class EditorLineHeight extends EditorIntOption {
  constructor() {
    super(51 /* lineHeight */, 'lineHeight', EDITOR_FONT_DEFAULTS.lineHeight, 0, 150, {
      description: nls.localize(
        'lineHeight',
...
class EditorMinimap extends BaseEditorOption {
  ...
  validate(_input) {
    ...
    return {
      ...
      showSlider: EditorStringEnumOption.stringSet(input.showSlider, this.defaultValue.showSlider, [
        'always',
        'mouseover',
      ]),
...
class EditorScrollbar extends BaseEditorOption {
  ...
  validate(_input) {
    ...
    return {
      ...
      horizontalHasArrows: EditorBooleanOption.boolean(
      ...
      alwaysConsumeMouseWheel: EditorBooleanOption.boolean(
...
class EditorSuggest extends BaseEditorOption {
  ...
  validate(_input) {
    ...
    const input = _input;
    return {
      insertMode: EditorStringEnumOption.stringSet(input.insertMode, this.defaultValue.insertMode, [
        'insert',
        'replace',
      ]),
      filterGraceful: EditorBooleanOption.boolean(input.filterGraceful, this.defaultValue.filterGraceful),
      snippetsPreventQuickSuggestions: EditorBooleanOption.boolean(
      ...
      shareSuggestSelections: EditorBooleanOption.boolean(
      ...
      maxVisibleSuggestions: EditorIntOption.clampedInt(
        input.maxVisibleSuggestions,
        this.defaultValue.maxVisibleSuggestions,
        1,
        15
      ),
      ...
      statusBar: {
        visible: EditorBooleanOption.boolean(
          (_a = input.statusBar) === null || _a === void 0 ? void 0 : _a.visible,
          !!this.defaultValue.statusBar.visible
        ),
      },
    };
  }
...
export const EditorOptions = {
  acceptSuggestionOnCommitCharacter: register(
    new EditorBooleanOption(0 /* acceptSuggestionOnCommitCharacter */, 'acceptSuggestionOnCommitCharacter', true, {
      markdownDescription: nls.localize(
  ...
  ariaLabel: register(
    new EditorStringOption(4 /* ariaLabel */, 'ariaLabel', nls.localize('editorViewAccessibleLabel', 'Editor content'))
  ),
  ...
  codeLens: register(
    new EditorBooleanOption(11 /* codeLens */, 'codeLens', true, {
      description: nls.localize('codeLens', 'Controls whether the editor shows CodeLens.'),
    })
  ),
  colorDecorators: register(
    new EditorBooleanOption(12 /* colorDecorators */, 'colorDecorators', true, {
      description: nls.localize(
        'colorDecorators',
  ...
  columnSelection: register(
    new EditorBooleanOption(13 /* columnSelection */, 'columnSelection', false, {
      description: nls.localize(
        'columnSelection',
  ...
  copyWithSyntaxHighlighting: register(
    new EditorBooleanOption(16 /* copyWithSyntaxHighlighting */, 'copyWithSyntaxHighlighting', true, {
      description: nls.localize(
  ...
  cursorSmoothCaretAnimation: register(
    new EditorBooleanOption(18 /* cursorSmoothCaretAnimation */, 'cursorSmoothCaretAnimation', false, {
      description: nls.localize(
  ...
  cursorWidth: register(
    new EditorIntOption(22 /* cursorWidth */, 'cursorWidth', 0, 0, 1073741824 /* MAX_SAFE_SMALL_INTEGER */, {
      markdownDescription: nls.localize(
        'cursorWidth',
  ...
  disableMonospaceOptimizations: register(
    new EditorBooleanOption(24 /* disableMonospaceOptimizations */, 'disableMonospaceOptimizations', false)
  ),
  dragAndDrop: register(
    new EditorBooleanOption(25 /* dragAndDrop */, 'dragAndDrop', true, {
      description: nls.localize(
        'dragAndDrop',
  ...
  fastScrollSensitivity: register(
    new EditorFloatOption(28 /* fastScrollSensitivity */, 'fastScrollSensitivity', 5, (x) => (x <= 0 ? 5 : x), {
  ...
  folding: register(
    new EditorBooleanOption(31 /* folding */, 'folding', true, {
      description: nls.localize('folding', 'Controls whether the editor has code folding enabled.'),
    })
  ),
  foldingStrategy: register(
    new EditorStringEnumOption(32 /* foldingStrategy */, 'foldingStrategy', 'auto', ['auto', 'indentation'], {
      enumDescriptions: [
        nls.localize(
  ...
  foldingHighlight: register(
    new EditorBooleanOption(33 /* foldingHighlight */, 'foldingHighlight', true, {
  ...
  unfoldOnClickAfterEndOfLine: register(
    new EditorBooleanOption(34 /* unfoldOnClickAfterEndOfLine */, 'unfoldOnClickAfterEndOfLine', false, {
      description: nls.localize(
  ...
  fontFamily: register(
    new EditorStringOption(35 /* fontFamily */, 'fontFamily', EDITOR_FONT_DEFAULTS.fontFamily, {
  ...
  formatOnPaste: register(
    new EditorBooleanOption(40 /* formatOnPaste */, 'formatOnPaste', false, {
      description: nls.localize(
        'formatOnPaste',
  ...
  formatOnType: register(
    new EditorBooleanOption(41 /* formatOnType */, 'formatOnType', false, {
      description: nls.localize(
        'formatOnType',
  ...
  glyphMargin: register(
    new EditorBooleanOption(42 /* glyphMargin */, 'glyphMargin', true, {
      description: nls.localize(
        'glyphMargin',
  ...
  hideCursorInOverviewRuler: register(
    new EditorBooleanOption(44 /* hideCursorInOverviewRuler */, 'hideCursorInOverviewRuler', false, {
      description: nls.localize(
  ...
  highlightActiveIndentGuide: register(
    new EditorBooleanOption(45 /* highlightActiveIndentGuide */, 'highlightActiveIndentGuide', true, {
      description: nls.localize(
  ...
  links: register(
    new EditorBooleanOption(54 /* links */, 'links', true, {
      description: nls.localize('links', 'Controls whether the editor should detect links and make them clickable.'),
    })
  ),
  matchBrackets: register(
    new EditorStringEnumOption(55 /* matchBrackets */, 'matchBrackets', 'always', ['always', 'near', 'never'], {
      description: nls.localize('matchBrackets', 'Highlight matching brackets.'),
    })
  ),
  minimap: register(new EditorMinimap()),
  mouseStyle: register(
    new EditorStringEnumOption(57 /* mouseStyle */, 'mouseStyle', 'text', ['text', 'default', 'copy'])
  ),
  ...
  mouseWheelZoom: register(
    new EditorBooleanOption(59 /* mouseWheelZoom */, 'mouseWheelZoom', false, {
      markdownDescription: nls.localize(
        'mouseWheelZoom',
  ...
  multiCursorMergeOverlapping: register(
    new EditorBooleanOption(60 /* multiCursorMergeOverlapping */, 'multiCursorMergeOverlapping', true, {
  ...
  multiCursorPaste: register(
    new EditorStringEnumOption(62 /* multiCursorPaste */, 'multiCursorPaste', 'spread', ['spread', 'full'], {
      markdownEnumDescriptions: [
  ...
  occurrencesHighlight: register(
    new EditorBooleanOption(63 /* occurrencesHighlight */, 'occurrencesHighlight', true, {
      description: nls.localize(
  ...
  overviewRulerBorder: register(
    new EditorBooleanOption(64 /* overviewRulerBorder */, 'overviewRulerBorder', true, {
      description: nls.localize(
        'overviewRulerBorder',
  ...
  peekWidgetDefaultFocus: register(
    new EditorStringEnumOption(68 /* peekWidgetDefaultFocus */, 'peekWidgetDefaultFocus', 'tree', ['tree', 'editor'], {
      enumDescriptions: [
  ...
  definitionLinkOpensInPeek: register(
    new EditorBooleanOption(69 /* definitionLinkOpensInPeek */, 'definitionLinkOpensInPeek', false, {
      description: nls.localize(
  ...
  renameOnType: register(
    new EditorBooleanOption(73 /* renameOnType */, 'renameOnType', false, {
      description: nls.localize('renameOnType', 'Controls whether the editor auto renames on type.'),
    })
  ),
  renderControlCharacters: register(
    new EditorBooleanOption(74 /* renderControlCharacters */, 'renderControlCharacters', false, {
      description: nls.localize(
  ...
  renderIndentGuides: register(
    new EditorBooleanOption(75 /* renderIndentGuides */, 'renderIndentGuides', true, {
      description: nls.localize('renderIndentGuides', 'Controls whether the editor should render indent guides.'),
    })
  ),
  renderFinalNewline: register(
    new EditorBooleanOption(76 /* renderFinalNewline */, 'renderFinalNewline', true, {
  ...
  renderLineHighlightOnlyWhenFocus: register(
    new EditorBooleanOption(78 /* renderLineHighlightOnlyWhenFocus */, 'renderLineHighlightOnlyWhenFocus', false, {
      description: nls.localize(
  ...
  renderValidationDecorations: register(
    new EditorStringEnumOption(79 /* renderValidationDecorations */, 'renderValidationDecorations', 'editable', [
      'editable',
      'on',
      'off',
    ])
  ...
  revealHorizontalRightPadding: register(
    new EditorIntOption(81 /* revealHorizontalRightPadding */, 'revealHorizontalRightPadding', 30, 0, 1000)
  ),
  roundedSelection: register(
    new EditorBooleanOption(82 /* roundedSelection */, 'roundedSelection', true, {
  ...
  scrollBeyondLastLine: register(
    new EditorBooleanOption(86 /* scrollBeyondLastLine */, 'scrollBeyondLastLine', true, {
      description: nls.localize(
  ...
  scrollPredominantAxis: register(
    new EditorBooleanOption(87 /* scrollPredominantAxis */, 'scrollPredominantAxis', true, {
      description: nls.localize(
  ...
  selectionClipboard: register(
    new EditorBooleanOption(88 /* selectionClipboard */, 'selectionClipboard', true, {
      description: nls.localize(
        'selectionClipboard',
  ...
  selectionHighlight: register(
    new EditorBooleanOption(89 /* selectionHighlight */, 'selectionHighlight', true, {
      description: nls.localize(
        'selectionHighlight',
  ...
  showUnused: register(
    new EditorBooleanOption(92 /* showUnused */, 'showUnused', true, {
      description: nls.localize('showUnused', 'Controls fading out of unused code.'),
    })
  ),
  showDeprecated: register(
    new EditorBooleanOption(113 /* showDeprecated */, 'showDeprecated', true, {
  ...
  smoothScrolling: register(
    new EditorBooleanOption(94 /* smoothScrolling */, 'smoothScrolling', false, {
  ...
  suggestFontSize: register(
    new EditorIntOption(97 /* suggestFontSize */, 'suggestFontSize', 0, 0, 1000, {
      markdownDescription: nls.localize(
        'suggestFontSize',
  ...
  suggestLineHeight: register(
    new EditorIntOption(98 /* suggestLineHeight */, 'suggestLineHeight', 0, 0, 1000, {
      markdownDescription: nls.localize(
        'suggestLineHeight',
  ...
  suggestOnTriggerCharacters: register(
    new EditorBooleanOption(99 /* suggestOnTriggerCharacters */, 'suggestOnTriggerCharacters', true, {
      description: nls.localize(
  ...
  tabCompletion: register(
    new EditorStringEnumOption(101 /* tabCompletion */, 'tabCompletion', 'off', ['on', 'off', 'onlySnippets'], {
      enumDescriptions: [
  ...
  tabIndex: register(
    new EditorIntOption(102 /* tabIndex */, 'tabIndex', 0, -1, 1073741824 /* MAX_SAFE_SMALL_INTEGER */)
  ),
  ...
  useTabStops: register(
    new EditorBooleanOption(104 /* useTabStops */, 'useTabStops', true, {
      description: nls.localize('useTabStops', 'Inserting and deleting whitespace follows tab stops.'),
    })
  ),
  wordSeparators: register(
    new EditorStringOption(105 /* wordSeparators */, 'wordSeparators', USUAL_WORD_SEPARATORS, {
      description: nls.localize(
        'wordSeparators',
  ...
  wordWrap: register(
    new EditorStringEnumOption(106 /* wordWrap */, 'wordWrap', 'off', ['off', 'on', 'wordWrapColumn', 'bounded'], {
      markdownEnumDescriptions: [
  ...
  wordWrapColumn: register(
    new EditorIntOption(109 /* wordWrapColumn */, 'wordWrapColumn', 80, 1, 1073741824 /* MAX_SAFE_SMALL_INTEGER */, {
      markdownDescription: nls.localize(
        {
          key: 'wordWrapColumn',
          comment: [
  ...
  wrappingStrategy: register(
    new EditorStringEnumOption(112 /* wrappingStrategy */, 'wrappingStrategy', 'simple', ['simple', 'advanced'], {
      enumDescriptions: [
        nls.localize(
