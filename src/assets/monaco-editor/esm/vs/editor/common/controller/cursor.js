...
export class Cursor extends Disposable {
  ...
  _emitCursorRevealRange(
    ...
    eventsCollector.emitViewEvent(
      new ViewRevealRangeRequestEvent(source, viewRange, viewSelections, verticalType, revealHorizontal, scrollType)
    );
  }
  saveState() {
    let result = [];
      ...
      if (this._hasFocus && e.resultingSelection && e.resultingSelection.length > 0) {
        ...
        if (
          this.setStates(
            eventsCollector,
            'modelChange',
            e.isUndoing ? 5 /* Undo */ : e.isRedoing ? 6 /* Redo */ : 2 /* RecoverFromMarkers */,
            cursorState
          )
        ) {
  ...
  _pushAutoClosedAction(autoClosedCharactersRanges, autoClosedEnclosingRanges) {
    ...
    this._autoClosedActions.push(
      new AutoClosedAction(this._model, autoClosedCharactersDecorations, autoClosedEnclosingDecorations)
    );
  }
  ...
  executeCommand(eventsCollector, command, source) {
    this._executeEdit(
      () => {
        ...
        this._executeEditOperation(
          new EditOperationResult(0 /* Other */, [command], {
  ...
  executeCommands(eventsCollector, commands, source) {
    this._executeEdit(
      () => {
        this._executeEditOperation(
          new EditOperationResult(0 /* Other */, commands, {
            shouldPushStackElementBefore: false,
            shouldPushStackElementAfter: false,
          })
        );
