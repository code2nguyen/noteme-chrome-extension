...
(function (AccessibilityHelpNLS) {
  ...
  AccessibilityHelpNLS.singleSelectionRange = nls.localize(
...
(function (StandaloneCodeEditorNLS) {
  ...
  StandaloneCodeEditorNLS.accessibilityHelpMessage = nls.localize(
