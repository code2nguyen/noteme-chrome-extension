...
function setNodeIsForValidation(node, value) {
  node.metadata =
    (node.metadata & 251) /* IsForValidationMaskInverse */ | ((value ? 1 : 0) << 2) /* IsForValidationOffset */;
}
...
function setNodeIsInOverviewRuler(node, value) {
  node.metadata =
    (node.metadata & 247) /* IsInOverviewRulerMaskInverse */ | ((value ? 1 : 0) << 3) /* IsInOverviewRulerOffset */;
}
...
function setCollapseOnReplaceEdit(node, value) {
  node.metadata =
    (node.metadata & 191) /* CollapseOnReplaceEditMaskInverse */ |
    ((value ? 1 : 0) << 6) /* CollapseOnReplaceEditOffset */;
}
...
export function nodeAcceptEdit(node, start, end, textLength, forceMoveMarkers) {
  ...
  const startStickToPreviousCharacter =
    nodeStickiness === 0 /* AlwaysGrowsWhenTypingAtEdges */ || nodeStickiness === 2 /* GrowsOnlyWhenTypingBefore */;
  const endStickToPreviousCharacter =
    nodeStickiness === 1 /* NeverGrowsWhenTypingAtEdges */ || nodeStickiness === 2 /* GrowsOnlyWhenTypingBefore */;
