...
function getDefaultMetadata(topLevelLanguageId) {
  return (
    ((topLevelLanguageId << 0) /* LANGUAGEID_OFFSET */ |
...
export class MultilineTokens2 {
  ...
  applyEdit(range, text) {
    ...
    this.acceptEdit(
      ...
      firstLineLength,
      lastLineLength,
      text.length > 0 ? text.charCodeAt(0) : 0 /* Null */
    );
  }
...
export class TokensStore2 {
  ...
  addSemanticTokens(lineNumber, aTokens) {
    ...
    for (let bIndex = 0; bIndex < bLen; bIndex++) {
      ...
      const bMask =
        ((bMetadata & 1 /* SEMANTIC_USE_ITALIC */ ? 2048 /* ITALIC_MASK */ : 0) |
          ...
          (bMetadata & 16 /* SEMANTIC_USE_BACKGROUND */ ? 4286578688 /* BACKGROUND_MASK */ : 0)) >>>
        0;
      const aMask = ~bMask >>> 0;
