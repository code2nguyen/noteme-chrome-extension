...
export class LineDecoration {
  ...
  static _equals(a, b) {
    return (
      a.startColumn === b.startColumn && a.endColumn === b.endColumn && a.className === b.className && a.type === b.type
    );
  }
...
export class LineDecorationsNormalizer {
  ...
  static normalize(lineContent, lineDecorations) {
    ...
    for (let i = 0, len = lineDecorations.length; i < len; i++) {
      ...
      const metadata =
        d.type === 1 /* Before */ ? 2 /* PSEUDO_BEFORE */ : d.type === 2 /* After */ ? 4 /* PSEUDO_AFTER */ : 0;
