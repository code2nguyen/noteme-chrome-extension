  ...
  constructor(diffEditor) {
    ...
    this._actionBar.push(
      new Action(
        ...
        'close-diff-review ' + diffReviewCloseIcon.classNames,
        true,
        () => {
          this.hide();
    ...
    this._register(
      dom.addStandardDisposableListener(this.domNode.domNode, 'keydown', (e) => {
        if (
        ...
        case 0 /* Equal */:
          if (originalLine === modifiedLine) {
            ariaLabel = nls.localize(
              {
                key: 'unchangedLine',
                comment: ['The placholders are contents of the line and should not be translated.'],
              },
              '{0} unchanged line {1}',
              lineContent,
              originalLine
