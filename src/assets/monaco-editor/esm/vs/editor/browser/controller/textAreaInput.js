...
export class TextAreaInput extends Disposable {
  constructor(host, textArea) {
    ...
    this._register(
      dom.addStandardDisposableListener(textArea.domNode, 'keydown', (e) => {
        if (
          e.keyCode === 109 /* KEY_IN_COMPOSITION */ ||
    ...
    this._register(
      dom.addStandardDisposableListener(textArea.domNode, 'keyup', (e) => {
        this._onKeyUp.fire(e);
      })
    );
    this._register(
      dom.addDisposableListener(textArea.domNode, 'compositionstart', (e) => {
    ...
    this._register(
      dom.addDisposableListener(textArea.domNode, 'compositionupdate', (e) => {
    ...
    this._register(
      dom.addDisposableListener(textArea.domNode, 'compositionend', (e) => {
    ...
    this._register(
      dom.addDisposableListener(textArea.domNode, 'cut', (e) => {
    ...
    this._register(
      dom.addDisposableListener(textArea.domNode, 'copy', (e) => {
        this._ensureClipboardGetsEditorSelection(e);
      })
    );
    this._register(
      dom.addDisposableListener(textArea.domNode, 'paste', (e) => {
  ...
  _ensureClipboardGetsEditorSelection(e) {
    const dataToCopy = this._host.getDataToCopy(
      ClipboardEventUtils.canUseTextData(e) && BrowserFeatures.clipboard.richText
    );
