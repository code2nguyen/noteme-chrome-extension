...
class BareHitTestRequest {
  constructor(ctx, editorPos, pos) {
    ...
    this.isInMarginArea =
      pos.x - editorPos.x < ctx.layoutInfo.contentLeft && pos.x - editorPos.x >= ctx.layoutInfo.glyphMarginLeft;
...
class HitTestRequest extends BareHitTestRequest {
  ...
  toString() {
    return `pos(${this.pos.x},${this.pos.y}), editorPos(${this.editorPos.x},${
      this.editorPos.y
    }), mouseVerticalOffset: ${this.mouseVerticalOffset}, mouseContentHorizontalOffset: ${
...
export class MouseTargetFactory {
  ...
  getMouseColumn(editorPos, pos) {
    ...
    const mouseContentHorizontalOffset =
      this._context.viewLayout.getCurrentScrollLeft() + pos.x - editorPos.x - layoutInfo.contentLeft;
    return MouseTargetFactory._getMouseColumn(
      mouseContentHorizontalOffset,
      options.get(36 /* fontInfo */).typicalHalfwidthCharacterWidth
    );
  }
