...
(function (CoreNavigationCommands) {
  ...
  CoreNavigationCommands.MoveTo = registerEditorCommand(
  ...
  CoreNavigationCommands.MoveToSelect = registerEditorCommand(
    new BaseMoveToCommand({
      id: '_moveToSelect',
  ...
  CoreNavigationCommands.ColumnSelect = registerEditorCommand(
    new (class extends ColumnSelectCommand {
      ...
      _getColumnSelectResult(viewModel, primary, prevColumnSelectData, args) {
        ...
        const validatedViewPosition = viewModel.coordinatesConverter.validateViewPosition(
          new Position(args.viewPosition.lineNumber, args.viewPosition.column),
          validatedPosition
        );
  ...
  CoreNavigationCommands.CursorColumnSelectLeft = registerEditorCommand(
    new (class extends ColumnSelectCommand {
      constructor() {
        super({
  ...
  CoreNavigationCommands.CursorColumnSelectRight = registerEditorCommand(
    new (class extends ColumnSelectCommand {
      constructor() {
        super({
  ...
  CoreNavigationCommands.CursorColumnSelectUp = registerEditorCommand(
  ...
  CoreNavigationCommands.CursorColumnSelectPageUp = registerEditorCommand(
    new ColumnSelectUpCommand({
      isPaged: true,
  ...
  CoreNavigationCommands.CursorColumnSelectDown = registerEditorCommand(
  ...
  CoreNavigationCommands.CursorColumnSelectPageDown = registerEditorCommand(
    new ColumnSelectDownCommand({
      isPaged: true,
  ...
  CoreNavigationCommands.CursorLeft = registerEditorCommand(
  ...
  CoreNavigationCommands.CursorLeftSelect = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 0 /* Left */,
        unit: 0 /* None */,
  ...
  CoreNavigationCommands.CursorRight = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 1 /* Right */,
        unit: 0 /* None */,
  ...
  CoreNavigationCommands.CursorRightSelect = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 1 /* Right */,
        unit: 0 /* None */,
  ...
  CoreNavigationCommands.CursorUp = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 2 /* Up */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorUpSelect = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 2 /* Up */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorPageUp = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 2 /* Up */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorPageUpSelect = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 2 /* Up */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorDown = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 3 /* Down */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorDownSelect = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 3 /* Down */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorPageDown = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 3 /* Down */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CursorPageDownSelect = registerEditorCommand(
    new CursorMoveBasedCommand({
      args: {
        direction: 3 /* Down */,
        unit: 2 /* WrappedLine */,
  ...
  CoreNavigationCommands.CreateCursor = registerEditorCommand(
  ...
  CoreNavigationCommands.LastCursorMoveToSelect = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
  ...
  CoreNavigationCommands.CursorHome = registerEditorCommand(
    new HomeCommand({
      inSelectionMode: false,
      id: 'cursorHome',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorHomeSelect = registerEditorCommand(
    new HomeCommand({
      inSelectionMode: true,
      id: 'cursorHomeSelect',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorLineStart = registerEditorCommand(
  ...
  CoreNavigationCommands.CursorLineStartSelect = registerEditorCommand(
    new LineStartCommand({
      inSelectionMode: true,
  ...
  CoreNavigationCommands.CursorEnd = registerEditorCommand(
    new EndCommand({
      inSelectionMode: false,
      id: 'cursorEnd',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorEndSelect = registerEditorCommand(
    new EndCommand({
      inSelectionMode: true,
      id: 'cursorEndSelect',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorLineEnd = registerEditorCommand(
    new LineEndCommand({
      inSelectionMode: false,
      id: 'cursorLineEnd',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorLineEndSelect = registerEditorCommand(
    new LineEndCommand({
      inSelectionMode: true,
  ...
  CoreNavigationCommands.CursorTop = registerEditorCommand(
    new TopCommand({
      inSelectionMode: false,
      id: 'cursorTop',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorTopSelect = registerEditorCommand(
    new TopCommand({
      inSelectionMode: true,
      id: 'cursorTopSelect',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorBottom = registerEditorCommand(
    new BottomCommand({
      inSelectionMode: false,
      id: 'cursorBottom',
      precondition: undefined,
  ...
  CoreNavigationCommands.CursorBottomSelect = registerEditorCommand(
    new BottomCommand({
      inSelectionMode: true,
  ...
  CoreNavigationCommands.ScrollLineUp = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'scrollLineUp',
  ...
  CoreNavigationCommands.ScrollPageUp = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'scrollPageUp',
  ...
  CoreNavigationCommands.ScrollLineDown = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'scrollLineDown',
  ...
  CoreNavigationCommands.ScrollPageDown = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'scrollPageDown',
  ...
  CoreNavigationCommands.WordSelect = registerEditorCommand(
    new WordCommand({
      inSelectionMode: false,
      id: '_wordSelect',
      precondition: undefined,
  ...
  CoreNavigationCommands.WordSelectDrag = registerEditorCommand(
    new WordCommand({
      inSelectionMode: true,
      id: '_wordSelectDrag',
      precondition: undefined,
  ...
  CoreNavigationCommands.LastCursorWordSelect = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
  ...
  CoreNavigationCommands.LineSelect = registerEditorCommand(
    new LineCommand({
      inSelectionMode: false,
      id: '_lineSelect',
      precondition: undefined,
  ...
  CoreNavigationCommands.LineSelectDrag = registerEditorCommand(
    new LineCommand({
      inSelectionMode: true,
      id: '_lineSelectDrag',
      precondition: undefined,
  ...
  CoreNavigationCommands.LastCursorLineSelect = registerEditorCommand(
  ...
  CoreNavigationCommands.LastCursorLineSelectDrag = registerEditorCommand(
    new LastCursorLineCommand({
      inSelectionMode: true,
  ...
  CoreNavigationCommands.ExpandLineSelection = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
  ...
  CoreNavigationCommands.CancelSelection = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'cancelSelection',
  ...
  CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
  ...
  CoreNavigationCommands.RevealLine = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'revealLine',
  ...
  CoreNavigationCommands.SetSelection = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'setSelection',
...
(function (CoreEditingCommands) {
  ...
  CoreEditingCommands.LineBreakInsert = registerEditorCommand(
  ...
  CoreEditingCommands.Outdent = registerEditorCommand(
    new (class extends CoreEditingCommand {
      constructor() {
        super({
          id: 'outdent',
  ...
  CoreEditingCommands.Tab = registerEditorCommand(
    new (class extends CoreEditingCommand {
      constructor() {
        super({
          id: 'tab',
  ...
  CoreEditingCommands.DeleteLeft = registerEditorCommand(
    new (class extends CoreEditingCommand {
      constructor() {
        super({
          id: 'deleteLeft',
          ...
          kbOpts: {
            ...
            mac: {
              primary: 1 /* Backspace */,
              secondary: [
                1024 /* Shift */ | 1 /* Backspace */,
                256 /* WinCtrl */ | 38 /* KEY_H */,
                256 /* WinCtrl */ | 1 /* Backspace */,
              ],
            },
          },
        });
  ...
  CoreEditingCommands.DeleteRight = registerEditorCommand(
    new (class extends CoreEditingCommand {
      constructor() {
        super({
          id: 'deleteRight',
