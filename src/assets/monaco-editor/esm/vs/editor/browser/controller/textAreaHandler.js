...
export class TextAreaHandler extends ViewPart {
  constructor(context, viewController, viewHelper) {
    ...
    const textAreaInputHost = {
      getDataToCopy: (generateHTML) => {
        ...
        const isFromEmptySelection =
          this._emptySelectionClipboard && this._modelSelections.length === 1 && this._modelSelections[0].isEmpty();
    ...
    this._register(
      this._textAreaInput.onSelectionChangeRequest((modelSelection) => {
  ...
  _render() {
    ...
    const top =
      this._context.viewLayout.getVerticalOffsetForLineNumber(this._selections[0].positionLineNumber) - this._scrollTop;
