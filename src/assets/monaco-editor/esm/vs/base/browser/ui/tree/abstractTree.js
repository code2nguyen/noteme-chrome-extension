  ...
  return (
    ...
    Object.assign(Object.assign({}, options), {
      ...
      multipleSelectionController: options.multipleSelectionController && {
        isSelectionSingleChangeEvent(e) {
          return options.multipleSelectionController.isSelectionSingleChangeEvent(
            Object.assign(Object.assign({}, e), { element: e.element })
          );
        },
      ...
      accessibilityProvider:
        ...
        Object.assign(Object.assign({}, options.accessibilityProvider), {
          getSetSize(node) {
      ...
      keyboardNavigationLabelProvider:
        ...
        Object.assign(Object.assign({}, options.keyboardNavigationLabelProvider), {
...
class TypeFilterController {
      ...
      .filter(
        (e) =>
          (this.keyboardNavigationDelegate.mightProducePrintableCharacter(e) &&
            !(
              (
                e.keyCode === 18 /* DownArrow */ ||
                e.keyCode === 16 /* UpArrow */ ||
                e.keyCode === 15 /* LeftArrow */ ||
                e.keyCode === 17
              ) /* RightArrow */
            )) ||
          ((this.pattern.length > 0 || this.triggered) &&
            ...
            !e.ctrlKey &&
            !e.metaKey) ||
          (e.keyCode === 1 /* Backspace */ && (isMacintosh ? e.altKey && !e.metaKey : e.ctrlKey) && !e.shiftKey)
      )
      .forEach((e) => {
        e.stopPropagation();
        e.preventDefault();
  ...
  render() {
    ...
    this.labelDomNode.textContent =
      this.pattern.length > 16 ? '…' + this.pattern.substr(this.pattern.length - 16) : this.pattern;
...
class Trait {
  ...
  onDidModelSplice({ insertedNodes, deletedNodes }) {
    ...
    const insertedNodesVisitor = (node) =>
...
class TreeNodeListMouseController extends MouseController {
  ...
  onViewPointer(e) {
    ...
    const onTwistie =
      hasClass(target, 'monaco-tl-twistie') ||
...
export class AbstractTree {
  constructor(user, container, delegate, renderers, _options = {}) {
    ...
    this.renderers = renderers.map(
      (r) => new TreeRenderer(r, () => this.model, onDidChangeCollapseStateRelay.event, activeNodes, _options)
    );
    ...
    onDidChangeActiveNodes.input = Event.chain(
      Event.any(onDidModelSplice, this.focus.onDidChange, this.selection.onDidChange)
    )
      .debounce(() => null, 0)
      .map(() => {
        const set = new Set();
