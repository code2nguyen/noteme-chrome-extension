...
class KeyboardController {
  constructor(list, view, options) {
    ...
    if (multipleSelectionSupport) {
      onKeyDown
        .filter((e) => (platform.isMacintosh ? e.metaKey : e.ctrlKey) && e.keyCode === 31 /* KEY_A */)
...
class TypeLabelController {
  ...
  updateOptions(options) {
    const enableKeyboardNavigation =
      typeof options.enableKeyboardNavigation === 'undefined' ? true : !!options.enableKeyboardNavigation;
  ...
  onClear() {
    ...
    if (focus.length > 0 && focus[0] === this.previouslyFocused) {
      ...
      const ariaLabel =
        (_a = this.list.options.accessibilityProvider) === null || _a === void 0
          ? void 0
          : _a.getAriaLabel(this.list.element(focus[0]));
      if (ariaLabel) {
        alert(ariaLabel);
      }
    }
...
class DOMFocusController {
  constructor(list, view) {
    ...
    const onKeyDown = Event.chain(domEvent(view.domNode, 'keydown'))
      ...
      .map((e) => new StandardKeyboardEvent(e));
    onKeyDown
      .filter((e) => e.keyCode === 2 /* Tab */ && !e.ctrlKey && !e.metaKey && !e.shiftKey && !e.altKey)
      ...
      .filter(
        (e) =>
          (this.didJustPressContextMenuKey =
            e.keyCode === 58 /* ContextMenu */ || (e.shiftKey && e.keyCode === 68) /* F10 */)
      )
      .filter((e) => {
        e.preventDefault();
        e.stopPropagation();
