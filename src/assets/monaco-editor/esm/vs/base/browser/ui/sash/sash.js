...
export class Sash extends Disposable {
  ...
  set orthogonalStartSash(sash) {
    ...
    if (sash) {
      this.orthogonalStartSashDisposables.add(
        sash.onDidEnablementChange(this.onOrthogonalStartSashEnablementChange, this)
      );
  ...
  onTouchStart(event) {
    ...
    listeners.push(
      addDisposableListener(this.el, EventType.Change, (event) => {
    ...
    listeners.push(
      addDisposableListener(this.el, EventType.End, (event) => {
        this._onDidEnd.fire();
        dispose(listeners);
      })
    );
