...
class ListViewAccessibilityProvider {
  constructor(accessibilityProvider) {
    if (
      accessibilityProvider === null || accessibilityProvider === void 0 ? void 0 : accessibilityProvider.getSetSize
    ) {
    ...
    if (
      accessibilityProvider === null || accessibilityProvider === void 0 ? void 0 : accessibilityProvider.getPosInSet
    ) {
...
export class ListView {
  constructor(container, virtualDelegate, renderers, options = DefaultOptions) {
    ...
    this.additionalScrollHeight =
      typeof options.additionalScrollHeight === 'undefined' ? 0 : options.additionalScrollHeight;
    ...
    this.scrollable = new Scrollable(getOrDefault(options, (o) => o.smoothScrolling, false) ? 125 : 0, (cb) =>
      DOM.scheduleAtNextAnimationFrame(cb)
    );
  ...
  get onMouseMiddleClick() {
    return Event.filter(
      Event.map(domEvent(this.domNode, 'auxclick'), (e) => this.toMouseEvent(e)),
  ...
  onDragOver(event) {
    ...
    event.browserEvent.dataTransfer.dropEffect =
      typeof result !== 'boolean' && result.effect === 0 /* Copy */ ? 'copy' : 'move';
    let feedback;
