...
export class Button extends Disposable {
  constructor(container, options) {
    ...
    [DOM.EventType.CLICK, EventType.Tap].forEach((eventType) => {
      this._register(
        DOM.addDisposableListener(this._element, eventType, (e) => {
          if (!this.enabled) {
    ...
    this._register(
      DOM.addDisposableListener(this._element, DOM.EventType.KEY_DOWN, (e) => {
    ...
    this._register(
      DOM.addDisposableListener(this._element, DOM.EventType.MOUSE_OVER, (e) => {
    ...
    this._register(
      DOM.addDisposableListener(this._element, DOM.EventType.MOUSE_OUT, (e) => {
