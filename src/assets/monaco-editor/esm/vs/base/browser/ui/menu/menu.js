...
import { SubmenuAction, Separator } from '../../../common/actions.js';
  ...
  doGetActionViewItem(action, options, parentData) {
    if (action instanceof Separator) {
      ...
      const menuActionViewItem = new SubmenuMenuActionViewItem(
        ...
        action.actions,
        parentData,
        Object.assign(Object.assign({}, options), { submenuIds: new Set([...(options.submenuIds || []), action.id]) })
      );
      if (options.enableMnemonics) {
...
class BaseMenuActionViewItem extends BaseActionViewItem {
  ...
  applyStyle() {
    ...
    const border =
      isSelected && this.menuStyle.selectionBorderColor ? `thin solid ${this.menuStyle.selectionBorderColor}` : '';
    if (this.item) {
...
class SubmenuMenuActionViewItem extends BaseMenuActionViewItem {
  constructor(action, submenuActions, parentData, submenuOptions) {
    ...
    this.expandDirection =
      submenuOptions && submenuOptions.expandDirection !== undefined ? submenuOptions.expandDirection : Direction.Right;
