...
class QuickPick extends QuickInput {
  constructor() {
    ...
    this._itemActivation = this.ui.isScreenReaderOptimized()
...
export class QuickInputController extends Disposable {
  ...
  getUI() {
    ...
    this._register(
      dom.addDisposableListener(container, dom.EventType.FOCUS, (e) => {
        inputBox.setFocus();
      })
    );
    this._register(
  ...
  hide() {
    ...
    if (controller) {
      const focusChanged = !((_a = this.ui) === null || _a === void 0
        ? void 0
        : _a.container.contains(document.activeElement));
      this.controller = null;
  ...
  updateStyles() {
    if (this.ui) {
      ...
      if (this.styles.list.listInactiveFocusForeground) {
        content.push(
          `.monaco-list .monaco-list-row.focused { color:  ${this.styles.list.listInactiveFocusForeground}; }`
        );
        content.push(
          `.monaco-list .monaco-list-row.focused:hover { color:  ${this.styles.list.listInactiveFocusForeground}; }`
